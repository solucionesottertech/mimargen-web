...
<!-- Who It's For -->
<section id="para-quien" class="py-24 sm:py-32 section-slate-tint section-spacing mt-32">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-2xl mx-auto mb-14 sm:mb-16 reveal">
        ...
        <div class="industry-icon-row reveal">
            ...
            <div class="industry-icon-item">
                <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8c-2 0-4 1-4 3s2 3 4 3 4-1 4-3-2-3-4-3z M6 16c0-2 2-4 6-4s6 2 6 4v2H6v-2z" /></svg>
            ...
            <div class="industry-icon-item">
                <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 3c-4 0-8 4-8 9s4 9 8 9 8-4 8-9-4-9-8-9z M12 3c0 4-2 8-2 12s2 6 2 6 M12 3c0 4 2 8 2 12s-2 6-2 6" /></svg>
...
<!-- Calculator -->
<section id="calculadora" class="py-24 sm:py-32 lg:py-40 bg-white mt-32 section-spacing">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-2xl mx-auto mb-14 sm:mb-16 reveal">
...
<!-- FAQ -->
<section id="faq" class="py-24 sm:py-32 section-slate-tint" style="margin-bottom: 12rem;">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-2xl mx-auto mb-14 sm:mb-16 reveal">
...
<!-- Final CTA -->
<section class="pt-48 pb-32 sm:pt-56 sm:pb-40 lg:pt-64 lg:pb-48 section-dark-cta text-white section-divider-strong">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto">
            <h2 class="text-white reveal">
                Deja de adivinar. <span class="text-brand-400">Empieza a saber.</span>
            </h2>
            <p class="mt-5 text-lg sm:text-xl text-slate-300 leading-relaxed reveal reveal-delay-1">
            ...
            <div class="mt-12 grid grid-cols-3 gap-8 reveal reveal-delay-1">
                <div class="text-center">
                    ...
                    <div class="text-sm text-slate-400 mt-1">Productores activos</div>
                </div>
                <div class="text-center">
